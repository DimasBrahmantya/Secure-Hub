  ...
  return (
    <div className="two-factor-container">
      <div className="two-factor-branding">
        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
          <svg className="w-12 h-12" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M24 44C24 44 40 36 40 24V10L24 4L8 10V24C8 36 24 44 24 44Z" stroke="#1E1E1E" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
          <h1>SecureHub</h1>
        </div>
      ...
      <div className="two-factor-card">
        ...
        <button onClick={handleSubmit} className="btn-authenticate">Authenticate</button>
        <button onClick={() => navigate("/login")} className="btn-back">Back to Login</button>
      </div>
    </div>
  );
}
